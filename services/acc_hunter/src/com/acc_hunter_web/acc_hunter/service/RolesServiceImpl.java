...
import com.acc_hunter_web.acc_hunter.Roles;
 ...
 * @see Roles
 */
@Service("acc_hunter.RolesService")
@Validated
public class RolesServiceImpl implements RolesService {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service acc_hunter for table Roles to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service acc_hunter for table Roles to {} format", options.getExportType());
