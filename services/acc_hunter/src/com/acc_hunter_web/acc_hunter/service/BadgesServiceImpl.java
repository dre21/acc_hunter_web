 ...
 * @see Badges
 */
@Service("acc_hunter.BadgesService")
@Validated
public class BadgesServiceImpl implements BadgesService {
    ...
    @Autowired
    @Qualifier("acc_hunter.BadgesDao")
    private WMGenericDao<Badges, String> wmGenericDao;
    ...
    public void setWMGenericDao(WMGenericDao<Badges, String> wmGenericDao) {
    ...
    @Override
    public Badges getById(String badgesId) {
    ...
    @Transactional(readOnly = true, value = "acc_hunterTransactionManager")
    @Override
    public Badges findById(String badgesId) {
        LOGGER.debug("Finding Badges by id: {}", badgesId);
        try {
            return this.wmGenericDao.findById(badgesId);
    ...
    @Transactional(readOnly = true, value = "acc_hunterTransactionManager")
    @Override
    public List<Badges> findByMultipleIds(List<String> badgesIds, boolean orderedReturn) {
    ...
    @Transactional(value = "acc_hunterTransactionManager")
    @Override
    public Badges partialUpdate(String badgesId, Map<String, Object>badgesPatch) {
    ...
    @Transactional(value = "acc_hunterTransactionManager")
    @Override
    public Badges delete(String badgesId) {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service acc_hunter for table Badges to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service acc_hunter for table Badges to {} format", options.getExportType());
    ...
    @Transactional(readOnly = true, value = "acc_hunterTransactionManager")
    @Override
    public Page<Users> findAssociatedUserses(String badgeType, Pageable pageable) {
        LOGGER.debug("Fetching all associated userses");

        StringBuilder queryBuilder = new StringBuilder();
        queryBuilder.append("badges.badgeType = '" + badgeType + "'");
