...
public interface BadgesService {
     ...
     */
    Badges getById(String badgesId);
     ...
     * @return Badges associated with the given badgesId.
     */
    Badges findById(String badgesId);
     ...
     */
    List<Badges> findByMultipleIds(List<String> badgesIds, boolean orderedReturn);
     ...
     * @throws EntityNotFoundException if no Badges is found with given input.
     */
    Badges partialUpdate(String badgesId, Map<String, Object> badgesPatch);
    ...
    /*
     * Returns the associated userses for given Badges id.
     *
     * @param badgeType value of badgeType; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<Users> findAssociatedUserses(String badgeType, Pageable pageable);
