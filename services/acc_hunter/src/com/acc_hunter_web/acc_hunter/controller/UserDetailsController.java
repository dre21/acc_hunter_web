...
import com.acc_hunter_web.acc_hunter.service.UserDetailsService;
 ...
 * @see UserDetails
 */
@RestController("acc_hunter.UserDetailsController")
@Api(value = "UserDetailsController", description = "Exposes APIs to work with UserDetails resource.")
@RequestMapping("/acc_hunter/UserDetails")
public class UserDetailsController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserDetailsController.class);

    @Autowired
	@Qualifier("acc_hunter.UserDetailsService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public UserDetails getByUserId(@PathVariable("userId") int userId) {
        LOGGER.debug("Getting UserDetails with uniques key UserId");
        return userDetailsService.getByUserId(userId);
    }
