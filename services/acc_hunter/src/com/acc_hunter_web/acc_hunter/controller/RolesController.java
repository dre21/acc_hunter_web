...
import com.acc_hunter_web.acc_hunter.service.RolesService;
 ...
 * @see Roles
 */
@RestController("acc_hunter.RolesController")
@Api(value = "RolesController", description = "Exposes APIs to work with Roles resource.")
@RequestMapping("/acc_hunter/Roles")
public class RolesController {

    private static final Logger LOGGER = LoggerFactory.getLogger(RolesController.class);

    @Autowired
	@Qualifier("acc_hunter.RolesService")
