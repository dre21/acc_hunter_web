...
Page.SKRequestsTable_updaterowAction = function($event, row) {
    App.Variables.agreementNo.dataSet.dataValue = row.aggrNo;
    App.Variables.userId.dataSet.dataValue = row.requestorId;
    App.Variables.skRequestId.dataSet.dataValue = row.id;
